...
from every row below. `1ef00ddc` is the publish that erased
it: it archived nothing, so it rebuilt this ledger from the
archive directory alone and wrote the rows back empty
