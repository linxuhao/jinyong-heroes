...
const EN: Dictionary = {
	...
	"河滩上两派剑客各立一端，\n口舌已僵，都请你执剑裁断。": "Two swordsmen stand at opposite ends of the riverbank;\nwords have failed, both ask you to settle it with steel.",
	...
	"荒村井水一夜发苦，\n药翁提药箱来，开口要价。": "Overnight the well water turned bitter in a remote village;\nan old herbalist arrives with his case and names a price.",
	"出银请药": "Pay for his medicine",
	"自学辨毒": "Study the poison yourself",
	"虎啸危崖": "Tiger's Cry at the Cliff",
	"崖下虎啸阵阵，\n商队头目兜售过路符。": "Tigers howl from the cliff below;\nthe caravan leader hawks safe-conduct talismans.",
	"买符通过": "Buy a talisman and pass",
	"攀崖绕行": "Climb the cliff and go around",
	"上元灯会": "Lantern Festival",
	"上元灯会人声鼎沸，\n灯摊谜面未解，猴子却已逃了。": "The Mid-Lantern fair roars with voices;\nthe riddle stall is unsolved, and the vendor's monkey has run off.",
	"破灯猜谜": "Solve the lantern riddle",
	"追猴拾遗": "Chase the monkey, pick up what it dropped",
	"当铺旧刀": "The Pawnshop Blade",
	"当铺柜台压着一柄断票旧刀，\n刀主落魄，已无力赎当。": "A pawnshop counter holds a blade past its ticket;\nits owner is ruined and cannot redeem it.",
	"断票贱收": "Buy it at a dead-ticket price",
	"代赎还主": "Redeem it for the owner",
	"茶馆说书": "The Teahouse Storyteller",
	"茶馆说书人正讲一段旧年剑侠，\n满堂喝彩，茶碗都忘了喝。": "A teahouse storyteller spins a tale of an old sword hero;\nthe whole room cheers, forgetting their tea.",
	"买茶续听": "Buy more tea, keep listening",
	"默记剑理": "Memorize the sword principles",
	"街角残局": "The Street Corner Endgame",
	"街角棋盘摆着一局残局，\n据说十年无人解出。": "A chessboard at the street corner holds an endgame;\nthey say no one has solved it in ten years.",
	"静思破局": "Think it through",
	"出银买谱": "Pay for the game record",
	"铸剑回炉": "Reforge at the Smithy",
	"铁匠铺炉火正旺，\n老铁匠说你的旧剑可以回炉重铸。": "The smithy fire burns high;\nthe old smith says your old blade can be reworked.",
	"出银回炉": "Pay to reforge it",
	"旁观剑理": "Watch the forging, study the blade",
	"崖上采药": "Herbs on the Cliff",
	"崖上采药人正招人攀崖，\n崖顶灵芝长势极好，亦可买去。": "A cliff gatherer is hiring a hand to climb;\nlotus grows lush at the top, and can be bought.",
	...
	"客栈掌柜伏在账本前揉眼，\n见你驻足，邀你帮算账或温酒暖身。": "The innkeeper slumps over his ledger, rubbing his eyes;\nseeing you pause, he offers to have you balance accounts or warm a pot of wine.",
	...
	"风雪封了隘口，\n向导蹲在火边，开口报了价。": "Snow has sealed the pass;\na guide crouches by the fire and names his price.",
	"出银雇导": "Hire the guide",
	"踏雪先行": "Tread the snow ahead",
	"醉汉传拳": "The Drunk's Fist",
	"醉汉在酒肆口手舞足蹈，\n看似胡闹，拳理却暗合章法。": "A drunk waves his fists outside the tavern;\nit looks like nonsense, but the forms follow real logic.",
	"买酒请教": "Buy him a drink, ask him to teach",
	"以拳换教": "Spar with him in exchange",
	"河伯娶亲": "The River God's Wedding",
	"河伯娶亲的鼓号从村头响起，\n巫师索价，村民面有难色，求你定夺。": "Drums and horns for the River God's wedding echo from the village;\nthe shamans demand a price, the villagers look to you.",
	"破局辨伪": "See through the fraud",
	"受金平事": "Accept silver to settle it",
	"疫村施药": "Medicine for the Plague Village",
	"疫村炊烟稀薄，\n村中郎中望着药柜叹气，缺药无力。": "Cooking smoke is thin in the plague village;\nthe local doctor stares at his empty cabinet and sighs.",
	"出银买药": "Buy medicine with silver",
	"自学方剂": "Study the formula yourself",
	"登门求教": "A Youth Seeks Instruction",
	"一名少年在门外徘徊良久，\n终于鼓足勇气，开口求你指点。": "A youth paces outside your door for a long while,\nthen finally gathers his courage and asks for your guidance.",
	"耐心点拨": "Guide him patiently",
	"收礼了事": "Accept a gift and be done",
	"坠马客商": "The Fallen Rider",
	"客商坠马，货物散落一地，\n他揉着腰，四下张望寻人搭手。": "A merchant has been thrown from his horse, goods scattered;\nhis hand on his back, he looks around for a helping hand.",
