...
const ROW_TITLES := {
	...
	"drunken_fist": "酒肆拳影", "river_god": "河伯娶亲", "plague_village": "疫村施药",
	"young_disciple": "登门求教", "fallen_rider": "途中坠马",
}
