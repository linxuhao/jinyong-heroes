...
| UX-03 | OPEN | 底部技能栏 | 技能按钮只有名称和「发挥 ×1.3」,没有效果说明,也没有内力消耗 | 无法判断该用哪一招,也不知道放完还剩多少内力。「修复已落,post-fix 闸门证据待验」 |
| UX-04 | OPEN | 底部技能栏 5–8 格 | 只写「锁定」,没有锁定原因或解锁条件 | 不知道为什么不能用,也不知道怎么解锁。「修复已落,post-fix 闸门证据待验」 |
| UX-05 | OPEN | 血条 | 条上没有任何数字或刻度 | 只能看出大概,说不出具体还剩多少血。**注**:2026-08-25 已把「有填充/有空白」修到原始尺寸下可辨(见 99_changelog),但数字仍然没有。「修复已落,post-fix 闸门证据待验」 |
