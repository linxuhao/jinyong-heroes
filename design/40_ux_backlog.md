...
| UX-03 | **CLOSED(jinyong-hud)** — 实测 5/5 全绿 | 底部技能栏 | 技能按钮只有名称和「发挥 ×1.3」,没有效果说明,也没有内力消耗 | 无法判断该用哪一招,也不知道放完还剩多少内力。**证据:playtest/skill_button_effect_info.yaml(`effect_text != ""`、`cost_text == "无消耗"`、`effect_summary_text != ""`、`fahui_text == "发挥 ×1.3"`、锁格负向对照)、final/hud_info_probe_notes.md、final/delivery_notes.md §8.1(2026-08-26 实测 PASS 5/5)** |
| UX-04 | **CLOSED(jinyong-hud)** — 实测 8/8 全绿 | 底部技能栏 5–8 格 | 只写「锁定」,没有锁定原因或解锁条件 | 不知道为什么不能用,也不知道怎么解锁。**证据:playtest/locked_slot_unlock_reason.yaml(5–8 格 reason 非空、1 格为空、第 4 轮翻转)、final/hud_info_probe_notes.md、final/delivery_notes.md §8.1(2026-08-26 实测 PASS 8/8)** |
| UX-05 | **CLOSED(jinyong-hud)** — 实测 5/5 全绿 | 血条 | 条上没有任何数字或刻度 | 只能看出大概,说不出具体还剩多少血。**注**:2026-08-25 已把「有填充/有空白」修到原始尺寸下可辨(见 99_changelog),但数字仍然没有。**证据:playtest/health_bar_numbers.yaml(`hp_text == str(hp_max)+"/"+str(hp_max)`、`hp_value < hp_max*0.5` 全对 max_health 表达,零绝对血量)、final/hud_info_probe_notes.md、final/delivery_notes.md §8.1(2026-08-26 实测 PASS 5/5)** |
